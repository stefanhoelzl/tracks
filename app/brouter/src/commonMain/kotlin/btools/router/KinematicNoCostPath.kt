...
internal class KinematicNoCostPath : OsmPath() {
    ...
    override fun init(orig: OsmPath?) {
        val origin = orig as KinematicNoCostPath
        ekin = origin.ekin
    ...
    override fun processWaySection(
        ...
        val km = rc.pm as KinematicNoCostModel
    ...
    protected fun evolveDistance(km: KinematicNoCostModel, dist: Double, delta_h: Double, f_air: Double): Double {
        // elevation force
    ...
    public override fun definitlyWorseThan(path: OsmPath?): Boolean {
        val p = path as KinematicNoCostPath
